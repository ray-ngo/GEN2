...
if exist %_iter_%_am_hov2_mc.skm del %_iter_%_am_hov2_mc.skm
copy %_HOV3PATH_%\%_iter_%_am_hov2_mc.skm %_iter_%_am_hov2_mc.skm /y
...
if exist %_iter_%_md_hov2_mc.skm del %_iter_%_md_hov2_mc.skm
copy %_HOV3PATH_%\%_iter_%_md_hov2_mc.skm %_iter_%_md_hov2_mc.skm /y
